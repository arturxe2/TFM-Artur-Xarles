...
class SoccerNetClips(Dataset):
    def __init__(self, path, features="ResNET_PCA512.npy", split=["train"], version=1, 
        ...
        self.class_weights1[self.class_weights1 <= 100] = 20
        self.class_weights1[(self.class_weights1 > 100) & (self.class_weights1 < 200)] = 30
        self.class_weights1[self.class_weights1 >= 200] = 40
