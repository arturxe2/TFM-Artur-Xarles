...
class Model(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.pool == "MAX":
            ...
            inputsB2 = inputsB2.permute((0, 2, 1))#(B x (chunk_size) x 512)
            inputsB3 = inputsB3.permute((0, 2, 1))#(B x (chunk_size) x 512)
            inputsB4 = inputsB4.permute((0, 2, 1))#(B x (chunk_size) x 512)
            inputsB5 = inputsB5.permute((0, 2, 1))#(B x (chunk_size) x 512)
